...
option_list <- list(
    ...
    make_option("--input_tsv_loc", type = "character", default = NULL, help = "File path to input mutation table in long format", metavar = "character"),
    ...
    make_option("--nProcs", type = "integer", default = 4,
